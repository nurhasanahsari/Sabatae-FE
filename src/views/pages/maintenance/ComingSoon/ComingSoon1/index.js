                  ...
                  <Grid container spacing={2}>
                    <Grid item xs={12}>
                      <Typography variant="h1" component="div">
                        Integrated Class System - KODIKALTAL
                      </Typography>
                    </Grid>
                    <Grid item xs={12}>
                      <Typography sx={{ fontSize: '1.125rem' }}>
                        Introducing Integrated Class System, the ultimate educational experience! Get the most out of your lessons with interactive
                        content, real-time collaboration tools, and a comprehensive library of resources. With Integrated Class System, you&apos;ll
                        learn more effectively and have more fun doing it. Unlock the power of modern technology for your classroom and take learning
                        to the next level!
                      </Typography>
                    </Grid>
                  </Grid>
                      ...
                      <Grid container justifyContent="space-between" spacing={gridSpacing}>
                        <Grid item xs={12}>
                          <Grid container justifyContent="flex-end" spacing={1}>
                            <Grid item>
                              <ButtonBase component={Link} href="#" target="_blank" aria-label="blog">
                                <Avatar
                                  sx={{
                            ...
                            <Grid item>
                              <ButtonBase component={Link} href="#" target="_blank" aria-label="facebook">
                                <Avatar
                                  sx={{
                                    ...theme.typography.commonAvatar,
                                    ...theme.typography.mediumAvatar,
                            ...
                            <Grid item>
                              <ButtonBase component={Link} href="#" target="_blank" aria-label="twitter">
                                <Avatar
                                  sx={{
                                    ...theme.typography.commonAvatar,
                                    ...theme.typography.mediumAvatar,
                            ...
                            <Grid item>
                              <ButtonBase component={Link} href="#" target="_blank" aria-label="github">
                                <Avatar
                                  sx={{
                                    ...theme.typography.commonAvatar,
                                    ...theme.typography.mediumAvatar,
                            ...
                            <Grid item>
                              <ButtonBase component={Link} href="#" target="_blank" aria-label="dribble">
                                <Avatar
                                  sx={{
                                    ...theme.typography.commonAvatar,
                                    ...theme.typography.mediumAvatar,
                        ...
                        <Grid item xs={12}>
                          <Grid container alignItems="center" justifyContent="flex-end" spacing={1}>
                            ...
                            <Grid item>
                              <img src={companyLogo} alt="Integrated Class System" width="128" />
                            </Grid>
                          </Grid>
                        </Grid>
                      </Grid>
