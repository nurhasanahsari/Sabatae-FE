...
const NavItem = ({ item, level, parentId }) => {
    ...
    const itemIcon = item?.icon ? (
        <Icon stroke={1.75} size="25px" style={{ color: isSelected ? theme.palette.text.light : theme.palette.text.light }} />
    ) : (
        <FiberManualRecordIcon
            sx={{
                color: isSelected ? theme.palette.text.light : theme.palette.text.light,
    ...
    const textColor = theme.palette.mode === 'dark' ? 'grey.400' : 'text.light';
    const iconSelectedColor = theme.palette.mode === 'dark' && drawerOpen ? 'text.light' : 'text.light';
            ...
            {layout === LAYOUT_CONST.VERTICAL_LAYOUT || (layout === LAYOUT_CONST.HORIZONTAL_LAYOUT && matchDownMd) ? (
                ...
                >
                    ...
                    {(drawerOpen || (!drawerOpen && level !== 1)) && (
                        <ListItemText
                            primary={
                                <Typography variant={isSelected ? 'h5' : 'body1'} color="text.light">
                                    {item.title}
                                </Typography>
                            }
                            secondary={
